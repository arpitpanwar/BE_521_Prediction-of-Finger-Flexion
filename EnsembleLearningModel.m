function [ models,chosenFeatures ] = EnsembleLearningModel( train_ecog_data,train_labels,samplingRate,windowSize,displ,subject )
...
%     end
    ...
    for i=1:5
         m= fitensemble(featureMat,trainlabels_decimated(:,i),'LSBoost',1000,'tree');
         models{i} = compact(m);
    end
