...
%Ridge
%[weights_sub1,pred_ridreg_sub1]= GenerateRidgeRegression(traindata_sub1,trainlabels_sub1,sr,windowSize,displ,testdata_sub1,testduration_sub1);
...
%Ridge
%[weights_sub2,pred_ridreg_sub2]= GenerateRidgeRegression(traindata_sub2,trainlabels_sub2,sr,windowSize,displ,testdata_sub2,testduration_sub2);
...
pred_sub2 = pred_linreg_sub2; % .* pred_svm_sub1;
...
%Ridge
%[weights_sub3,pred_ridreg_sub3]= GenerateRidgeRegression(traindata_sub3,trainlabels_sub3,sr,windowSize,displ,testdata_sub3,testduration_sub3);
...
pred_sub3 = pred_linreg_sub3; % .* pred_svm_sub1;
...
save('LeaderboardPrediction_Sequentialfs.mat','predicted_dg');