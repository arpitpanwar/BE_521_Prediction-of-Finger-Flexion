...
[weight_mat_2,predictions_2] = GenerateMovementReduction(traindata_sub2, ...
        trainlabels_sub2,sr,windowSize,displ,testdata_sub2,testduration_sub2,subject, 0, 1000,1200);
...
[weight_mat_3,predictions_3] = GenerateMovementReduction(traindata_sub3, ...
        trainlabels_sub3,sr,windowSize,displ,testdata_sub3,testduration_sub3,subject, 0, 1000,1200);
    %linear regression
