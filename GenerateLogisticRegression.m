function [ mdl_log_reg,predicted_dg ] = GenerateLogisticRegression()
    ...
    weight_sub1 = LogisticRegressionModel(traindata_ecog_sub1,trainlabels_sub_1,sr);
    ...
    %Predicting
    pred_rounded_sub1 = Prediction_LogReg(weight_sub1,train_limits,testdata_ecog_sub1,sr,testDuration);
    ...
    weight_sub2 = LogisticRegressionModel(traindata_ecog_sub2,trainlabels_sub_2,sr);
    ...
    %Predicting
    pred_rounded_sub2 = Prediction_LogReg(weight_sub2,train_limits,testdata_ecog_sub2,sr,testDuration);
    ...
    weight_sub3 = LogisticRegressionModel(traindata_ecog_sub3,trainlabels_sub_3,sr);
    ...
    %Predicting
    pred_rounded_sub3 = Prediction_LogReg(weight_sub3,train_limits,testdata_ecog_sub3,sr,testDuration);
    ...
    save('LeaderBoardSubmission_logreg.mat','predicted_dg');
