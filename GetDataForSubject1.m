function [ traindata,trainlabels,testdata,testDuration, totalDuration] = GetDataForSubject1(user)

if exist('Subject1_data.mat','file')
    ...
    save('Subject1_data.mat','testdata','trainlabels','traindata','testDuration', 'totalDuration');
