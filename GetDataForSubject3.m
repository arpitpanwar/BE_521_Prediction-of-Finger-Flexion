function [ traindata,trainlabels,testdata,testDuration,totalDuration ] = GetDataForSubject3(user )
    
if exist('Subject3_data.mat','file')
    ...
    if user == 1
       ...
       save('Subject3_data.mat','testdata','trainlabels','traindata','testDuration','totalDuration');
