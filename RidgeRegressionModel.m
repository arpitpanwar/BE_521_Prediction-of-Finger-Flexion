...
%         save(strcat('features_emp',num2str(subject),'_k25.mat'),'featureMat');
    
    switch subject
        case 1
        load 'features_emp1_k25.mat';
        load('ranks_emp1_k25_new.mat');
            numFeatures = 25;
        case 2
        load 'features_emp2_k25.mat';
        load('ranks_emp2_k25_new.mat');
            numFeatures = 35;
        case 3
        load 'features_emp3_k25.mat';
        load('ranks_emp3_k25_new.mat');
            numFeatures = 15;
    end
...
%   save(strcat('ranks_emp',num2str(subject),'_rlowes_k',num2str(K),'.mat'),'ranks');

    chosenFeatures = unique(features);
     
%    save(strcat('chosenfeatures_rlowess_sub',num2str(subject),'.mat'),'chosenFeatures');
