...
%Predicting
pred_rounded_sub1 = Prediction_LinearReg(weight_sub1,trainlabels_sub_1,traindata_ecog_sub1,sr,totalDuration);   
...
%testdata_ecog_sub2 = session_sub2_test.data.getvalues(1:round(sr*testDuration),1:62);

%Predicting
pred_rounded_sub2 = Prediction_LinearReg(weight_sub2,trainlabels_sub_2,traindata_ecog_sub2,sr,totalDuration);   
...
%testdata_ecog_sub3 = session_sub3_test.data.getvalues(1:round(sr*testDuration),1:62);

%Predicting
pred_rounded_sub3 = Prediction_LinearReg(weight_sub3,trainlabels_sub_3,traindata_ecog_sub3,sr,totalDuration);   
