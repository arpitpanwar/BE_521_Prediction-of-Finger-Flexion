function [ weight_mat ] = LogisticRegressionModel( train_ecog_data,train_labels,samplingRate,windowSize,displ )
...
%     end
    ...
    weight_mat = mnrfit(featureMat,trainlabels_decimated);
