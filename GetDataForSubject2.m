...
if user == 1
    session_sub2_ecog = IEEGSession('I521_A0012_D001','arpitpanwar','../arp_ieeglogin.bin');
    session_sub2_dglov = IEEGSession('I521_A0012_D002','arpitpanwar','../arp_ieeglogin.bin');
    session_sub2_test = IEEGSession('I521_A0012_D003','arpitpanwar','../arp_ieeglogin.bin');
else
    session_sub2_ecog = IEEGSession('I521_A0012_D001','jburrell','../jbu_ieeglogin.bin');
    session_sub2_dglov = IEEGSession('I521_A0012_D002','jburrell','../jbu_ieeglogin.bin');
    session_sub2_test = IEEGSession('I521_A0012_D003','jburrell','../jbu_ieeglogin.bin');
end
