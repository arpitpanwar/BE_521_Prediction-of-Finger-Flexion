function [ traindata,trainlabels,testdata,testDuration,totalDuration] = GetDataForSubject2(user)

if exist('Subject2_data.mat','file')
    ...
    if user == 1
       ...
       save('Subject2_data.mat','testdata','trainlabels','traindata','testDuration', 'totalDuration');
end
end
